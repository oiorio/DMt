...
parser.add_option('-M','--maximum', dest='maximum',type=int,default=16,help="maximum mass point (*200), default =16-1 (=> 3000),")
...
#f3s
models_f3s_yyqcd_nlo={"F3S_YYQCD_NLO_SMt":("F3S_YYQCD_NLO_SMt_MY1300_MX900_topologyinstructions","F3S_YYQCD_NLO_SMt_MY1300_MX900_runinstructions",
                             {"out":"output DMtsimp/MG5Runs/F3S_YYQCD_NLO_SMt_MY1300_MX900","mx":"MXs","my":"MYF3u3"},
                             "F3S_YYQCD_NLO_SMt_MY1300_MX900_MA5recastinstructions_proto",{"imp":"import /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/","imp2":"import PYTHIAFILE as F3S_YYQCD_NLO_SMt_MY1300_MX900","imp3":"set main.recast.card_path = /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/RecastingCards/recasting_card_2023.dat","xs2":"set F3S_YYQCD_NLO_SMt_MY1300_MX900.xsection = SED_CROSSSECTION" },"F3S_YYQCD_NLO_SMt_MY1300_MX900_sfsinstructions_proto")}
...
models_f3s_xx_nlo={"F3S_XX_NLO_SMt":("F3S_XX_NLO_SMt_MY1300_MX900_topologyinstructions","F3S_XX_NLO_SMt_MY1300_MX900_runinstructions",
                             ...
                             "F3S_XX_NLO_SMt_MY1300_MX900_MA5recastinstructions_proto",{"imp":"import /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/","imp2":"import PYTHIAFILE as F3S_XX_NLO_SMt_MY1300_MX900","imp3":"set main.recast.card_path = /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/RecastingCards/recasting_card_2023.dat","xs2":"set F3S_XX_NLO_SMt_MY1300_MX900.xsection = SED_CROSSSECTION" },"F3S_XX_NLO_SMt_MY1300_MX900_sfsinstructions_proto")}
...
models_f3c_yyqcd_nlo={"F3C_YYQCD_NLO_SMt":("F3C_YYQCD_NLO_SMt_MY1300_MX900_topologyinstructions","F3C_YYQCD_NLO_SMt_MY1300_MX900_runinstructions",
                             ...
                             "F3C_YYQCD_NLO_SMt_MY1300_MX900_MA5recastinstructions_proto",{"imp":"import /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/","imp2":"import PYTHIAFILE as F3C_YYQCD_NLO_SMt_MY1300_MX900","imp3":"set main.recast.card_path = /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/RecastingCards/recasting_card_2023.dat","xs2":"set F3C_YYQCD_NLO_SMt_MY1300_MX900.xsection = SED_CROSSSECTION" },"F3C_YYQCD_NLO_SMt_MY1300_MX900_sfsinstructions_proto")}
...
models_s3m_yyqcd_nlo={"S3M_YYQCD_NLO_SMt":("S3M_YYQCD_NLO_SMt_MY1300_MX900_topologyinstructions","S3M_YYQCD_NLO_SMt_MY1300_MX900_runinstructions",
                             ...
                             "S3M_YYQCD_NLO_SMt_MY1300_MX900_MA5recastinstructions_proto",{"imp":"import /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/","imp2":"import PYTHIAFILE as S3M_YYQCD_NLO_SMt_MY1300_MX900","imp3":"set main.recast.card_path = /afs/cern.ch/work/o/oiorio/DMMC/MG5_aMC_v2_9_15/RecastingCards/recasting_card_2023.dat","xs2":"set S3M_YYQCD_NLO_SMt_MY1300_MX900.xsection = SED_CROSSSECTION" },"S3M_YYQCD_NLO_SMt_MY1300_MX900_sfsinstructions_proto")}
...
if opt.model=="f3c_yyqcd_nlo":
    ...
    if(os.path.exists("success_mass_pairs_f3c_yyqcd_nlo.py") ): 
        from success_mass_pairs_f3c_yyqcd_nlo import successful_pairs
    else:
       successful_pairs={"F3C_YYQCD_NLO_SMt":[]}
...
if opt.model=="f3s_yyqcd_nlo":
    models=models_f3s_yyqcd_nlo
    if(os.path.exists("success_mass_pairs_f3s_yyqcd_nlo.py") ): 
       from success_mass_pairs_f3s_yyqcd_nlo import successful_pairs
    else:
       successful_pairs={"F3S_YYQCD_NLO_SMt":[]}
#f3v
